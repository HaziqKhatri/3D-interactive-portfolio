    ...
    <div className="flex items-center justify-center">
      <Modal>
        <ModalTrigger className="bg-transparent flex justify-center group/modal-btn">
          ...
          >
            <Image
              className="absolute w-full h-full top-0 left-0 hover:scale-105 transition-all"
              src={project.src}
              alt={project.title}
              width={400}
              height={267}
        ...
        <ModalBody className="md:max-w-4xl md:max-h-[80%] overflow-auto">
          ...
          <ModalFooter className="gap-4">
            <button
              className="px-2 py-1 bg-gray-200 text-black dark:bg-black dark:border-black dark:text-white 
            ...
            <Link href={project.live} target="_blank" rel="noopener noreferrer">
              <button
                className="bg-black text-white dark:bg-white dark:text-black text-sm px-2 py-1 rounded-md 
                           border border-black w-28"
              >
                Visit
              </button>
            </Link>
